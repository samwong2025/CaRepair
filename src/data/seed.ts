...
const orderSpecs: SeedOrderSpec[] = [
  ...
  },
  {
    ...
    appointmentAt: hoursAgo(4),
    remark: '螢幕右下角爆裂，觸控尚可但怕擴散，希望今日內取機。',
  },
  {
    orderNo: 'CR-20260809-Q58B',
    customerIndex: 4,
    modelId: 'watch-s10-46',
    symptomIds: ['battery_aging'],
    serviceMode: 'walk_in',
    ...
    appointmentAt: daysAgo(1, 14, 0),
    remark: 'Apple Watch 续航明顯下跌，一日要充兩次電。',
  },
  {
    orderNo: 'CR-20260810-M33C',
    customerIndex: 1,
    modelId: 'iphone-16-pro-max',
    symptomIds: ['back_glass'],
    serviceMode: 'mail_in',
    address: '九龍觀塘鴻圖道 26 號 8 樓',
    status: 'quality_check',
    technician: '家明',
    createdAt: hoursAgo(8),
    appointmentAt: hoursAgo(6),
    remark: '背玻璃裂但不影響使用，順便清機身。',
  },
  {
    orderNo: 'CR-20260809-M77D',
    customerIndex: 3,
    modelId: 'ipad-air-11-m3',
    symptomIds: ['water_damage'],
    serviceMode: 'mail_in',
    address: '新界沙田大圍積存街 15 號 3 樓',
    status: 'repairing',
    technician: '家明',
    createdAt: daysAgo(1, 16, 40),
    appointmentAt: daysAgo(1, 18, 0),
    remark: '飲料潑到，充電偶有斷開，公司設計圖檔需保全。',
  },
];
