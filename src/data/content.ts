...
export const servicePillars = [
  {
    ...
    description:
      '駐店技師平均 8 年蘋果裝置維修經驗，全部通過 IPC-7711 焊接認證，配備顯微焊台與 BGA 植球設備，主機板級故障亦可即場處理。',
    icon: 'BadgeCheck',
    points: ['IPC 國際焊接認證', '顯微鏡下晶片級維修', '維修全程錄影可回看'],
  },
  {
    id: 'quality',
    title: '嚴苛品檢・180 日保養',
    ...
    description:
      '每部維修完成的裝置須通過 27 項功能檢測（觸控、鏡頭、訊號、防水、電池健康度等），檢測報告隨機附上，保養期內同一故障免費復修。',
    icon: 'ShieldCheck',
...
export const orderSteps = [
  ...
  },
  {
    ...
    title: '約時間',
    titleEn: 'Book & Submit',
    description: '選擇到店快修、上門收送或順豐寄修，填妥聯絡資料即自動開立會員檔案，並可即時追蹤進度。',
    icon: 'CalendarCheck',
    duration: '約 40 秒',
  },
] as const;
...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    content:
      '換電池全程有錄影，仲畀我睇返舊電池個健康度同拆機過程，真係好放心。做完健康度返到 100%，用足一日都仲有 40%。',
    tags: ['#全程錄影', '#換電池', '#放心'],
  ...
  },
  {
    ...
    rating: 5,
    content:
      '網上落單揀咗上門收機，順豐一個鐘就上到嚟收，翌日就整好送返。全程 WhatsApp 有進度通知，唔使自己追。',
    tags: ['#上門收送', '#進度通知', '#夠快'],
...
export const faqs = [
  {
    q: '維修需要幾耐？可唔可以即場等？',
    a: '換螢幕、換電池、換尾插等常見故障約 30 至 60 分鐘即場完成，可以喺店內等。入水、主機板級維修或資料救援需送內部實驗室處理，一般 1 至 3 個工作天，落單後可於「訂單查詢」實時睇到進度。',
  },
  {
    q: '網上報價同實際收費會唔會有出入？',
  ...
  {
    q: '維修會唔會睇到我部機入面嘅資料？',
    a: '不會。維修全程錄影，技師不會解鎖、瀏覽或備份任何個人資料。除非你申請「資料救援」服務並簽署授權書，我哋才會接觸儲存內容，完成後亦會即時清除工作副本。',
  },
  {
    q: '保養期點計？包唔包人為損壞？',
