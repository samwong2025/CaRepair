...
export const deviceModels: DeviceModel[] = [
  ...
  /* ── Apple Watch ──────────────────────────── */
  { id: 'watch-ultra-2', category: 'watch', name: 'Apple Watch Ultra 2', series: 'Ultra', year: 2023, tier: 'flagship', hot: true, image: 'watch-ultra.png', },
  { id: 'watch-ultra', category: 'watch', name: 'Apple Watch Ultra', series: 'Ultra', year: 2022, tier: 'flagship', image: 'watch-ultra.png', },
  { id: 'watch-s10-46', category: 'watch', name: 'Apple Watch Series 10（46mm）', series: 'Series 10', year: 2024, tier: 'premium', hot: true, image: 'watch-series.png', },
  { id: 'watch-s10-42', category: 'watch', name: 'Apple Watch Series 10（42mm）', series: 'Series 10', year: 2024, tier: 'premium', image: 'watch-series.png', },
  { id: 'watch-s9-45', category: 'watch', name: 'Apple Watch Series 9（45mm）', series: 'Series 9', year: 2023, tier: 'standard', hot: true, image: 'watch-series.png', },
  { id: 'watch-s9-41', category: 'watch', name: 'Apple Watch Series 9（41mm）', series: 'Series 9', year: 2023, tier: 'standard', image: 'watch-series.png', },
  { id: 'watch-s8-45', category: 'watch', name: 'Apple Watch Series 8（45mm）', series: 'Series 8', year: 2022, tier: 'standard', image: 'watch-series.png', },
  { id: 'watch-s8-41', category: 'watch', name: 'Apple Watch Series 8（41mm）', series: 'Series 8', year: 2022, tier: 'standard', image: 'watch-series.png', },
  { id: 'watch-se-2', category: 'watch', name: 'Apple Watch SE（第 2 代）', series: 'SE', year: 2022, tier: 'legacy', image: 'watch-se.png', },
  { id: 'watch-s7', category: 'watch', name: 'Apple Watch Series 7', series: 'Series 7', year: 2021, tier: 'legacy', image: 'watch-series.png', },
  { id: 'watch-s6', category: 'watch', name: 'Apple Watch Series 6', series: 'Series 6', year: 2020, tier: 'legacy', image: 'watch-series.png', },

  /* 以下型號依 iwatchrepair.co.uk 列出的完整機型譜補齊（Series 1–5 / 11、SE 初代與 2025、Ultra 3） */
  { id: 'watch-s1-38', category: 'watch', name: 'Apple Watch Series 1（38mm）', series: 'Series 1', year: 2015, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s1-42', category: 'watch', name: 'Apple Watch Series 1（42mm）', series: 'Series 1', year: 2015, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s2-38', category: 'watch', name: 'Apple Watch Series 2（38mm）', series: 'Series 2', year: 2016, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s2-42', category: 'watch', name: 'Apple Watch Series 2（42mm）', series: 'Series 2', year: 2016, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s3-38', category: 'watch', name: 'Apple Watch Series 3（38mm）', series: 'Series 3', year: 2017, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s3-42', category: 'watch', name: 'Apple Watch Series 3（42mm）', series: 'Series 3', year: 2017, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s4-40', category: 'watch', name: 'Apple Watch Series 4（40mm）', series: 'Series 4', year: 2018, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s4-44', category: 'watch', name: 'Apple Watch Series 4（44mm）', series: 'Series 4', year: 2018, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s5-40', category: 'watch', name: 'Apple Watch Series 5（40mm）', series: 'Series 5', year: 2019, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-s5-44', category: 'watch', name: 'Apple Watch Series 5（44mm）', series: 'Series 5', year: 2019, tier: 'legacy', image: 'watch-classic.png', },
  { id: 'watch-se-1-40', category: 'watch', name: 'Apple Watch SE（第 1 代・40mm）', series: 'SE', year: 2020, tier: 'legacy', image: 'watch-se.png', },
  { id: 'watch-se-1-44', category: 'watch', name: 'Apple Watch SE（第 1 代・44mm）', series: 'SE', year: 2020, tier: 'legacy', image: 'watch-se.png', },
  { id: 'watch-s11-42', category: 'watch', name: 'Apple Watch Series 11（42mm）', series: 'Series 11', year: 2025, tier: 'premium', hot: true, image: 'watch-series.png', },
  { id: 'watch-s11-46', category: 'watch', name: 'Apple Watch Series 11（46mm）', series: 'Series 11', year: 2025, tier: 'premium', hot: true, image: 'watch-series.png', },
  { id: 'watch-se-3-40', category: 'watch', name: 'Apple Watch SE（第 3 代・40mm）', series: 'SE', year: 2025, tier: 'standard', hot: true, image: 'watch-se.png', },
  { id: 'watch-se-3-44', category: 'watch', name: 'Apple Watch SE（第 3 代・44mm）', series: 'SE', year: 2025, tier: 'standard', hot: true, image: 'watch-se.png', },
  { id: 'watch-ultra-3', category: 'watch', name: 'Apple Watch Ultra 3（49mm）', series: 'Ultra', year: 2025, tier: 'flagship', hot: true, image: 'watch-ultra.png', },
